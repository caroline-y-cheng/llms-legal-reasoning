...
output_path = os.path.join(interp_dir, 'gpt4_1', 'gpt4_1_chain_ft_results')
...
# train_path = 'train_test_splits/gpt_chain_train_4.jsonl'
# eval_path = 'train_test_splits/gpt_chain_test_4.jsonl'
...
def get_descriptive_interp(text, prompt_text):
  ...
  response = openai.chat.completions.create(
      model="ft:gpt-4.1-2025-04-14:cornell-law-projects:legal-reasoning-chain:Ce3PrMoS",
      max_tokens=2,
...
full_df.to_csv(os.path.join(output_path, 'gpt_chain_ft_results.csv'))
