...
output_path = os.path.join(interp_dir, 'gpt4_1', 'gpt4_1_binary_ft_results')
...
# train_path = 'train_test_splits/gpt_binary_train_4.jsonl'
# eval_path = 'train_test_splits/gpt_binary_test_4.jsonl'
...
# train_file_id='file-4ZGXWbEq3FxmQk1oQ3GwE4'
# validation_file_id='file-SM3wgtzSsUN35J9qRdAUjH'
...
def get_binary_interp(text, interpretation_prompt):
  response = openai.chat.completions.create(
      model="ft:gpt-4.1-2025-04-14:cornell-law-projects::Ce0XRdkY",
      max_tokens=5,
...
full_df.to_csv(os.path.join(output_path, 'gpt_interpretation_ft_results.csv'))
