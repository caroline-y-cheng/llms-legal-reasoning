...
output_path = os.path.join(interp_dir, 'gpt4_1', 'gpt4_1_few_shot_ft_results')
...
# train_path = 'train_test_splits/gpt_few_shot_train_4.jsonl'
# eval_path = 'train_test_splits/gpt_few_shot_test_4.jsonl'
...
# training_file_id='file-CkqnBipXdEf365RwPAtp97'
# validation_file_id='file-Mrsdip9jsgu9PfG15BYfCZ'

# openai.fine_tuning.jobs.create(
#   training_file=training_file_id,
#   validation_file=validation_file_id,
#   model="gpt-4.1-2025-04-14",
#   suffix='legal_reasoning_few_shot'
# )
...
def get_few_shot_interp(text, formal_example, grand_example, none_example):
    ...
    response = openai.chat.completions.create(
        model="ft:gpt-4.1-2025-04-14:cornell-law-projects:legal-reasoning-few-shot:Ce9KtDXZ",
        max_tokens=3,
...
full_df.to_csv(os.path.join(output_path, 'gpt_few_shot_ft_results.csv'))
