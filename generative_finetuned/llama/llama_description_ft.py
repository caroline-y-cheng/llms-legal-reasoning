...
models = {"llama_8B_description" : "meta-llama/Meta-Llama-3.1-8B-Instruct", "llama_70B_description" : "meta-llama/Meta-Llama-3.1-70B-Instruct"} 
...
for model_name, BASE_MODEL in models.items():
    ...
    train_path = 'train_test_splits/description_train_4.jsonl'
    eval_path = 'train_test_splits/description_test_4.jsonl'
