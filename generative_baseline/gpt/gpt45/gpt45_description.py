...
models = {"gpt4_1" : "gpt-4.1-2025-04-14", "gpt5_2" : "gpt-5.2-2025-12-11"} 

for model_name, model in models.items():
  interp_dir = os.getcwd()
  train_test_dir = os.path.join(interp_dir, 'train_test_splits')
  output_path = os.path.join(interp_dir, model_name, model_name + '_description_results')
  ...
  def get_descriptive_interp(text, formal_description, grand_description, none_description):
    ...
    response = openai.chat.completions.create(
        model=model,
        max_tokens=2, # for gpt-4.1-2025-04-14
  ...
  full_df.to_csv(os.path.join(output_path, 'gpt_description_results.csv'))
